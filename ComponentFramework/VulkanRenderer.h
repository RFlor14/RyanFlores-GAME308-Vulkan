...
struct ModelVertexData {
    ...
    uint64_t indexBufferMemorySize;
};
...
private:
    ...
    void createGraphicsPipeline(const char* idName, const std::string& vertShaderName_, const std::string& fragShaderName_);
    ...
    void loadModel(const char* idName, const char* filename);
    ...
    UniformBufferObject ubo{}; //stack structure
